...
INSERT INTO test.Units (unit_id, unit_name, subject_id, Units_order, description, materials_path, text, text_description) VALUES (32, 'Beginner Spanish Unit 2', 7, 2, 'the 2nd unit of Beginner Spanish ', 'https://www.youtube.com/embed/dOhtVXr05Gc', null, null);
INSERT INTO test.Units (unit_id, unit_name, subject_id, Units_order, description, materials_path, text, text_description) VALUES (33, 'Beginner Spanish Unit 3', 7, 3, 'the 3rd unit of Beginner Spanish ', 'https://www.youtube.com/embed/McR7pDWlnJo', null, null);
INSERT INTO test.Units (unit_id, unit_name, subject_id, Units_order, description, materials_path, text, text_description) VALUES (34, 'Beginner Spanish Unit 4', 7, 4, 'the 4th unit of Beginner Spanish ', 'https://www.youtube.com/embed/27KsV2MUKGU', null, null);
INSERT INTO test.Units (unit_id, unit_name, subject_id, Units_order, description, materials_path, text, text_description) VALUES (35, 'Beginner Spanish Unit 5', 7, 5, 'the 5th unit of Beginner Spanish ', 'https://www.youtube.com/embed/EVByP8ls1Lg', null, null);
INSERT INTO test.Units (unit_id, unit_name, subject_id, Units_order, description, materials_path, text, text_description) VALUES (36, 'Intermediate Spanish Unit 1', 8, 1, 'the 1st unit of Intermediate Spanish ', 'https://www.youtube.com/embed/kGYk2ka5IT0', null, null);
...
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (41, 'What color is shown in the picture below?', 3, 'https://tomatolearning.s3.amazonaws.com/picture/yellow.png', null, null, 1, 'It\'s a yellow picture and "amarillo" means yellow in Spanish.', 'It\'s a yellow picture. We have four option A) Rojo, B) Azul, C) Verde and D) Amarillo. Which one is correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (42, 'What color snow is?', 1, null, null, null, 2, 'Snow is white and "blanco" means white in Spanish.', 'Snow is white. We have four options A) Negro, B) Rosa, C) Blanco and D) Azul. Which one is correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (43, 'Choose what you hear.', 5, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/rosa.mp3', 3, 'The audio plays "rosa", which means "pink" in Spanish.', 'The audio plays "rosa", which means "pink" in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (44, 'Choose what you hear.', 10, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/azul_verde.mp3', 4, 'The audio plays "La taza es azul. El sombrero es verde", which means "The cup is blue. The hat is green" in Spanish.', 'The audio plays "La taza es azul. El sombrero es verde", which means "The cup is blue. The hat is green" in Spanish. There are four options A) Naranja, B) Rosa, C) Verde and D) Azul. Which options are correct and explain why?');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (45, 'Choose the option(s) that describes the picture.', 8, 'https://tomatolearning.s3.amazonaws.com/picture/apple.png', null, null, 5, 'It\'s a picture of apple. There are green, red and brown in this picture.', 'It\'s a picture of apple, there are red, green and brown color in the picture. The four options are A) Verde, B) Marrón, C) Manzana and D)Rojo. So these four are all correct. ');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (46, 'What animals are in this picture?', 8, 'https://tomatolearning.s3.amazonaws.com/picture/dog_cat.png', null, null, 1, '"Perro and Gato" mean "dog and cat"', 'It\'s a picture of dog and cat. There are four options A) Conejo, B) Gato, C) Perro and D)Lobo. What options are correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (47, 'Choose what you hear.', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/oso.mp3', 2, '"Oso" means "bear"', 'The audio plays "Oso" which means "bear" in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (48, 'What animals live under water?', 6, null, null, null, 3, '"Tiburón and Pulpo" mean "shark and octopus"', 'What animals live under water? There are four options: A) Tiburón, B) Pulpo, C) Tigre and D) Serpiente. What options are correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (49, 'What animal is it in the picture?', 3, 'https://tomatolearning.s3.amazonaws.com/picture/sheep.png', null, null, 4, '"Oveja" means sheep', 'What animal is it in the picture? It\'s a picture of sheep. There are four options: A) Vaca, B) Pollo, C) Oveja and D) Delfín. What option is correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (50, 'What animal is in the audio?', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/jirafa.mp3', 5, '"Jirafa" means "giraffe"', 'The audio plays "Jirafa" which means "giraffe" in Spanish. There are four options: A) Cabra, B) Gorila, C) Ganso and D) Jirafa. What option is correct and explain why.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (51, 'How to spell 23?', 1, null, null, null, 1, '"twenty-three"', 'The number "23" is spelled as "twenty-three."');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (52, 'What number is in the audio?', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/spanish_17.mp3', 2, '"diecisiete(17)"', 'The audio plays "diecisiete(17)".');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (53, 'Choose the number(s) smaller than the number in the audio.', 9, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/spanish_39.mp3', 3, 'choose number smaller than 39', 'Choose the number(s) smaller than "treinta y nueve(39)" which is played in the audio.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (54, 'Choose which is "Cero"', 1, null, null, null, 4, '"0"', '0 is "Cero".');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (55, 'How to spell 100?', 1, null, null, null, 5, '"cien"', 'The number "100" is spelled as "cien" in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (56, 'What month comes right after "Enero"?', 1, null, null, null, 1, 'Febrero(February)', 'The month that comes after Enero(January) is Febrero(February).');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (57, 'What\'s the last month of a year?', 1, null, null, null, 2, 'Diciembre(December)', 'What\'s the last month of a year? ');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (58, 'What month comes after May in a year?', 6, null, null, null, 3, 'Julio(July), Agosto(August)', 'What month comes after June in a year?');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (59, 'Choose what month is it.', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/junio.mp3', 4, 'Junio(June)', 'The audio plays "Junio" which means June in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (60, 'Choose what month is it.', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/noviembre.mp3', 5, 'Noviembre(November)', 'The audio plays "Noviembre" which means November in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (61, 'Choose what you hear.', 4, null, null, 'https://tomatolearning.s3.amazonaws.com/audio/hasta_luego.mp3', 1, '"hasta luego" means "see you later".', 'The audio plays "hasta luego" which means "see you later" in Spanish.');
INSERT INTO test.questions (question_id, question, question_type_id, picture_path, video_path, audio_path, question_order, explanation, description) VALUES (62, '"See you soon" in Spanish.', 1, null, null, null, 2, '"See you soon" in Spanish is "hasta pronto."', '"See you soon" in Spanish is "hasta pronto."');
...
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (56, 56, 35);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (57, 57, 35);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (58, 58, 35);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (59, 59, 35);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (60, 60, 35);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (61, 61, 36);
INSERT INTO test.question_units (question_unit_id, question_id, unit_id) VALUES (62, 62, 36);
...
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (162, 41, 'Azul', 0, 2, 'Azul means blue in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (163, 41, 'Verde', 0, 3, 'Verde means green in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (164, 41, 'Amarillo', 1, 4, 'Amarillo means yellow in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (165, 42, 'Negro', 0, 1, 'Negro means black in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (166, 42, 'Rosa', 0, 2, 'Rosa means pink in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (167, 42, 'Blanco', 1, 3, 'Blanco means white in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (168, 42, 'Azul', 0, 4, 'Azul means blue in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (169, 43, 'https://tomatolearning.s3.amazonaws.com/option/orange.png', 0, 1, 'this is an orange picture Orange in Spanish is Naranja');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (170, 43, 'https://tomatolearning.s3.amazonaws.com/option/purple.png', 0, 2, 'this is a purple picture. Purple in Spanish is Morado or Púrpura (both are commonly used)');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (171, 43, 'https://tomatolearning.s3.amazonaws.com/option/pink.png', 1, 3, 'this is a pink picture. Pink in Spanish is Rosa.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (172, 43, 'https://tomatolearning.s3.amazonaws.com/option/blue.png', 0, 4, 'this is a blue picture. Blue in Spanish is Azul.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (173, 44, 'https://tomatolearning.s3.amazonaws.com/option/orange.png', 0, 1, 'this is an orange picture Orange in Spanish is Naranja');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (174, 44, 'https://tomatolearning.s3.amazonaws.com/option/pink.png', 0, 2, 'this is a pink picture. Pink in Spanish is Rosa.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (175, 44, 'https://tomatolearning.s3.amazonaws.com/option/green.png', 1, 3, 'this is a green picture. Green in Spanish is Verde.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (176, 44, 'https://tomatolearning.s3.amazonaws.com/option/blue.png', 1, 4, 'this is a blue picture. Blue in Spanish is Azul.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (177, 45, 'Verde', 1, 1, 'Verde means green in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (178, 45, 'Marrón', 1, 2, 'Marrón means brown in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (179, 45, 'Manzana', 1, 3, 'Manzana means apple in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (180, 45, 'Rojo', 1, 4, 'Rojo means red in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (181, 46, 'Conejo', 0, 1, 'Conejo means rabbit in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (182, 46, 'Gato', 1, 2, 'Gato means cat in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (183, 46, 'Perro', 1, 3, 'Perro menas dog in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (184, 46, 'Lobo', 0, 4, 'Lobo means wolf in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (185, 47, 'Pez', 0, 1, '"Pez" means fish in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (186, 47, 'Gato', 0, 2, '"Gato" means cat in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (187, 47, 'Caballo', 0, 3, '"Caballo" means horse in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (188, 47, 'Oso', 1, 4, '"Oso" means bear in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (189, 48, 'Tiburón', 1, 1, '"Tiburón" means shark in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (190, 48, 'Pulpo', 1, 2, '"Pulpo" means octopus in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (191, 48, 'Tigre', 0, 3, '"Tigre" means tiger in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (192, 48, 'Serpiente', 0, 4, '"Serpiente" means snake in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (193, 49, 'Vaca', 0, 1, '"Vaca" means cow in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (194, 49, 'Pollo', 0, 2, '"Pollo" means chicken in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (195, 49, 'Oveja', 1, 3, '"Oveja" means sheep in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (196, 49, 'Delfín', 0, 4, '"Delfín" means dolphin in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (197, 50, 'Cabra', 0, 1, '"Cabra" means goat in Spanish.');
...
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (221, 56, 'Febrero', 1, 1, 'Febrero means February in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (222, 56, 'Mayo', 0, 2, 'Mayo means May in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (223, 56, 'Agosto', 0, 3, 'Agosto means August in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (224, 56, 'Noviembre', 0, 4, 'Noviembre means November in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (225, 57, 'Enero', 0, 1, 'Enero means January in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (226, 57, 'Diciembre', 1, 2, 'Diciembre means December in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (227, 57, 'Septiembre', 0, 3, 'Septiembre means September in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (228, 57, 'Octubre', 0, 4, 'Octubre means October in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (229, 58, 'Julio', 1, 1, 'Julio means July');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (230, 58, 'Junio', 1, 2, 'Junio means June');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (231, 58, 'Marzo', 0, 3, 'Marzo means March');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (232, 58, 'Abril', 0, 4, 'Abril means April');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (233, 59, 'Mayo', 0, 1, 'Mayo means May in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (234, 59, 'Julio', 0, 2, 'Julio means July');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (235, 59, 'Junio', 1, 3, 'Junio means June');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (236, 59, 'Agosto', 0, 4, 'Agosto means August in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (237, 60, 'Diciembre', 0, 1, 'Diciembre means December in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (238, 60, 'Octubre', 0, 2, 'Octubre means October in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (239, 60, 'Noviembre', 1, 3, 'Noviembre means November in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (240, 60, 'Septiembre', 0, 4, 'Septiembre means September in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (241, 61, 'See you soon.', 0, 1, 'Wrong answer. "Hasta luego" means "see you later" in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (242, 61, 'Hello.', 0, 2, 'Wrong answer. "Hasta luego" means "see you later" in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (243, 61, 'Goodbye.', 0, 3, 'Wrong answer. "Hasta luego" means "see you later" in Spanish.');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (244, 61, 'See you later.', 1, 4, 'correct');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (245, 62, 'Adiós', 0, 1, 'Adiós means "goodbye" in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (246, 62, 'Hasta la vista', 0, 2, 'Hasta la vista means "until we see each other" in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (247, 62, 'Hasta luego', 1, 3, 'Hasta luego means "see you later" in Spanish');
INSERT INTO test.options (option_id, question_id, `option`, is_correct, order_number, description) VALUES (248, 62, 'Hasta pronto', 0, 4, 'Hasta pronto means "see you soon" in Spanish.');
