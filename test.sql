...
INSERT INTO `questions` (`question_id`, `question`, `question_type_id`, `picture_path`, `video_path`, `audio_path`, `question_order`, `explanation`, `description`) VALUES (12, 'What animal is shown in this video?', 4, NULL, NULL, 'https://tomatolearning.s3.amazonaws.com/audio/bear.mp3', 2, '\"bear\"', '1');
